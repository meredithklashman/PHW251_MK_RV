...
x2 <- left_join(countydemo5, x, by = "County") %>%
...
```{r, echo = TRUE}
#Ruben: Use Merged_Dataset. Countydemo5 data indicates the selected 5 counties
#if you want to focus on those for one of the tables!
#Include code for title and footnote. 
#format all variables (i.e Strata Name instead of Strata_Name)

#i.e. hospital closure data for those 5 counties 
```
Interpretation: (Ruben: 1-2 Sentences
